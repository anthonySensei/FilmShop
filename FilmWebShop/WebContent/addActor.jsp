...
<body>
<%
			if(session.getAttribute("userid")==null){   //check if the user log in // if not redirect user to login page
...
<p>
<h2 style="margin-left: 80px">Please enter actor information</h2>
<p>
        <form action="/FilmWebShop/AddActorServlet" method="post">
                ...
                <div class="row">
                    <div class="col-sm">
                        <input type="text" name="name" style="width:400px"
                               placeholder="Full name of the actor"   
                               data-toggle="tooltip"
