...
<p>
<h2 style="margin-left: 90px">Choose option: </h2>
<p>
<div class="container" style="margin-top: 10px; margin-left: 80px">
                <div class="row">
                    <div class="col-sm">
						<a href="/FilmWebShop/profile.jsp"><font color="#ff7733">Change personal information</font></a>
				   </div>
				</div>
				<div class="row">
                    <div class="col-sm">
						<a href="/FilmWebShop/changePassword.jsp"><font color="#ff7733">Change password</font></a>
      				</div>
				</div>
      </div>  
</div>
