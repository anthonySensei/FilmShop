...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
        <li class="nav-item ">
            <a class="nav-link" href="/FilmWebShop/home.jsp"><font style="color: white">Home</font></a>
        </li>
        </ul>
</div> 
<div style="margin-right:1500px" class="collapse navbar-collapse" id="navbarSupportedContent">
       ...
       <a class="nav-link" href="/FilmWebShop/SearchFilmServlet"><img src="https://cdn1.iconfinder.com/data/icons/hawcons/32/698956-icon-111-search-128.png" style="width: 40px; height: 40px"></a>
        </div>
